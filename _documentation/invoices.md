...
- `{FY}`        - full numeric representation of set finacial year (4 digits). Example: `2023`
- `{fy}`        - two digit representation of set finacial year. Example: `23`
- `{fiscal}`    - a fiscal (financial) year format representation of set finacial year. Example: `2023-24`
